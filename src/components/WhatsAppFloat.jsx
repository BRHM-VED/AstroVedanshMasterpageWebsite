...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="whatsapp-float-btn fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-xl transition hover:scale-110"
    >
